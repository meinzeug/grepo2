#!/usr/bin/env python3
"""
grepo2 v3.7.3.2 - Git Repository Management Tool
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

🎯 TUI Navigation Restoration:
   • Wiederherstellung der vollständigen Menüführung aus v3.7.2
   • Beibehaltung des modernen Look & Feel aus v3.7.3.1
   • Preservation aller v3.7.3+ Features (Auto-Close, CHANGELOG)
...
class CodexIntegration:
    ...
    def generate_comprehensive_prompt(self, issue: Dict[str, Any], comments: List[str], repo_path: Path) -> str:
        ...
        prompt = f"""
ENTWICKLUNGSAUFTRAG für Repository: {repo_path.name}
═══════════════════════════════════════════════════
