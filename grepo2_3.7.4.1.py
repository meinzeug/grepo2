#!/usr/bin/env python3
"""
grepo2 v3.7.4.1 - Git Repository Management Tool
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
# ─── Section IV: OpenRouter API Integration (v3.7.4.1 NEW) ──────────────────────

def fetch_openrouter_models(token: str) -> List[Dict[str, Any]]:
    """Fetch free coding models from OpenRouter API (v3.7.4.1)"""
    try:
        headers = {
        ...
        # Use top_provider.max_completion_tokens if available, otherwise fallback
